...
exports.CurrencyModule = CurrencyModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([currency_entity_1.Currency, blockchain_entity_1.Blockchain])],
        controllers: [currency_controller_1.CurrencyController],
        providers: [currency_service_1.CurrencyService],
        exports: [currency_service_1.CurrencyService, typeorm_1.TypeOrmModule],
    })
], CurrencyModule);
